...
#'
#' @description A version of Linear Discriminant Analysis that can deal with observation weights.
#'
#' @details The formulas for the weighted estimates of the class means, the covariance matrix and the class priors are as follows:
#'
#' Normalized weights:
...
#'
#' @description Classify observations in conjunction with \code{\link{wlda}}.
#'
