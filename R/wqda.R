...
#'
#' @description A version of Quadratic Discriminant Analysis that can deal with observation weights.
#'
#' @details The formulas for the weighted estimates of the class means, the covariance matrices and the class priors are as follows:
#'
#' Normalized weights:
