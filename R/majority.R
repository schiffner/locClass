...
#'
#' @description A classifier that always predicts the class with the highest weighted prior
#'	probability.
#'
#' @details This function is a helper function needed to combine mixture models and recursive
...
#' @param na.action A function to specify the action to be taken if NAs are found. The default action
...
#' @family majority
#'
#' @aliases majority majority.data.frame majority.default majority.formula majority.matrix
#'
#' @export
