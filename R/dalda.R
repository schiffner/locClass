...
#'
#' @description A local version of Linear Discriminant Analysis that puts increased emphasis on a good 
#'	model fit near the decision boundary.
#'
#' @details The idea of Hand and Vinciotti (2003) to put increased weight on observations near the
